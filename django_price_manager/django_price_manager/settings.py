"""
Django settings for django_price_manager project.
...
ROOT_URLCONF = "django_price_manager.urls"
...
WSGI_APPLICATION = "django_price_manager.wsgi.application"
...
DATABASE_ROUTERS = ["django_price_manager.routers.DatabaseRouter"]
